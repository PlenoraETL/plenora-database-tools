...
| AST spatial | catalogo tipizzato | 23 metodi nativi comuni tipizzati | **chiusa per il sottoinsieme comune pubblicato**: accessori, validazione, predicati, misure, processing e join fra colonne su source fisiche; i nove output geometrici sono WKB Z/M-safe con profilo del risultato e prova live geometry/geography |
