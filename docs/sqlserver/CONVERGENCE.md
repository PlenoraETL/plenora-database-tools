...
| AST spatial | catalogo tipizzato | 23 metodi nativi comuni tipizzati | **chiusa per il sottoinsieme comune pubblicato**: accessori, validazione, predicati, misure, indicizzazione dei punti, buffer, overlay booleani, unione e inviluppo convesso; i nove output geometrici sono WKB Z/M-safe con profilo del risultato e prova live geometry/geography |
