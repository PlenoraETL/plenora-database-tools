...
def generate_tls(entry: MatrixEntry) -> None:
    run(
        [
            ...
            "/tls",
            "/fixture/server.ext",
            # Il nome per cui il certificato è emesso. MySQL e MariaDB hanno
            # host distinti, quindi il generatore non può scegliere un default.
            # `dataflow-mysql` è l'alias di rete che
