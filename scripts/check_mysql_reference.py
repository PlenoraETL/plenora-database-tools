...
EXPECTED_UNIT_TESTS = {
    ...
    "profile::tests::the_mariadb_catalog_differs_only_where_the_column_does_not_exist",
    ...
    "profile::tests::the_shared_code_table_keeps_the_verdict_and_changes_the_name",
