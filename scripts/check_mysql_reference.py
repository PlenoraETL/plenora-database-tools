...
EXPECTED_UNIT_TESTS = {
    ...
    "evidence::tests::a_contract_without_a_question_does_not_invent_one",
    "evidence::tests::a_read_that_meets_the_contract_has_nothing_to_report",
    "evidence::tests::a_refusal_for_another_reason_is_not_the_one_expected",
    ...
    "profile::tests::the_catalog_queries_that_coincide_are_written_once",
    "profile::tests::the_catalog_reads_no_alias_the_contract_does_not_declare",
    "profile::tests::the_constructor_attributes_its_own_failures_to_the_profile",
    ...
    "profile::tests::the_probe_asks_the_version_question_too",
    ...
    "profile::tests::the_statement_timeout_is_classified_as_a_timeout_on_both_products",
    "profile::tests::the_statement_timeout_keeps_the_contract_unit",
    "profile::tests::the_two_profiles_partition_the_servers_that_were_measured",
    "profile::tests::the_two_profiles_publish_distinct_metadata_namespaces",
    "profile::tests::the_version_is_a_second_question_after_the_product",
    "profile::tests::the_wire_mapper_does_not_diverge_between_the_profiles",
    "profile::tests::the_wire_produces_the_native_type_that_diverged",
    ...
    "query::tests::a_computed_argument_moves_the_question_instead_of_answering_it",
    "query::tests::a_declaration_on_another_column_does_not_travel",
    "query::tests::a_grouped_query_cannot_carry_the_confirmation",
    "query::tests::a_preserving_function_inherits_the_declared_crs_of_its_column",
    "query::tests::a_scalar_argument_is_not_a_place_a_frame_could_come_from",
    "query::tests::a_rule_that_is_not_preserves_stays_closed",
    "query::tests::a_verified_geometry_function_carries_a_rule_the_provider_can_use",
    ...
    "query::tests::one_column_gets_one_confirmation_however_many_times_it_is_projected",
    ...
    "query::tests::the_confirmation_column_renders_as_srid_of_the_source",
    ...
    "query::tests::without_a_declaration_there_is_nothing_to_inherit",
    "query::tests::zero_is_the_ogc_undefined_and_is_not_a_declaration",
    ...
    "transaction::tests::a_geometry_column_stays_binary",
    "transaction::tests::a_json_column_stays_a_string",
    ...
    "transaction::tests::a_missing_cell_is_a_protocol_error",
    "transaction::tests::a_text_column_stays_text",
    "transaction::tests::a_text_column_with_invalid_utf8_is_an_error",
    ...
    "types::tests::a_declared_crs_compiles_and_carries_its_verification",
    "types::tests::a_declared_crs_reaches_the_published_field",
    "types::tests::a_geometry_without_a_declared_srid_is_refused_by_both_profiles",
    "types::tests::a_geometry_without_catalog_or_plan_srid_is_still_refused",
    ...
    "types::tests::qualified_checkpoint_renders_as_a_bound_mysql_keyset",
...
EXPECTED_LIVE_DEFAULT_TESTS = {
    ...
    "live_tests::live_v12_a_computed_geometry_carries_the_declared_frame_and_refuses_a_lie",
    "live_tests::live_v12_every_verified_spatial_function_executes",
...
EXPECTED_LIVE_REFERENCE_TESTS = {
    ...
    "live_tests::live_keyset_checkpoint_persists_reopens_without_duplicates_or_gaps",
