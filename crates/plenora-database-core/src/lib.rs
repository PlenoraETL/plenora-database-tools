...
pub use facade::{
    ...
    execute_portable_returning, execute_portable_returning_one, execute_scalar_bool,
    execute_scalar_bytes, execute_scalar_date, execute_scalar_decimal, execute_scalar_enum,
