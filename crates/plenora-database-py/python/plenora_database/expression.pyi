...
class SelectStatement(ExecutableStatement):
    ...
    def join(
        ...
        on: Predicate | None = ..., *, kind: str = "inner", lateral: bool = ...,
    ) -> Self: ...
    ...
    def distinct_on(self, *expressions: Expression) -> Self: ...
    def with_for_update(
        self, *relations: str | Table | DerivedTable | CommonTable,
        strength: str = ..., nowait: bool = ..., skip_locked: bool = ...,
    ) -> Self: ...
...
def case(
    *branches: tuple[Predicate, Expression], else_: Expression | None = None
) -> CaseExpression: ...
